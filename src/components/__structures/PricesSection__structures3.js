...
export default function PricesSection__structures3() {
    return (
        <React.Fragment>
            <>
                <div>
  ...
  <section className="pt-28 pb-20 bg-white overflow-hidden">
    <div className="container">
      <div className="text-center mb-28">
        <h3 className="fs-20 fw-semibold text-secondary-light text-uppercase mb-6" style={{letterSpacing: 1}}>The features that made us special</h3>
        <h2 className="fs-10 fw-semibold mb-0">Here’s how it works</h2>
      </div>
      <div className="mw-6xl mx-auto">
        <div className="row g-16">
          <div className="col-12 col-md-4">
            <div className="text-center">
              <svg className="mx-auto mb-9" width={50} height={50} viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <h3 className="fs-16 fw-medium lh-base mb-0">Subscribe to a plan that suits you better and place orders as many as you want.</h3>
            </div>
          </div>
          <div className="col-12 col-md-4">
            <div className="text-center">
